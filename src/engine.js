...
export class Engine {
  ...
  frame(dt=1/60,{draw=true,train=true}={}){
    ...
    // Primary visibility now ray-queries the exact shared assets.cu grammar for every lot.
    // Do not materialise alternate page representations in the render loop.
