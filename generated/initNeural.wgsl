// CUDA WebShader 0.1.0. Generated from kernel initNeural.
@group(0) @binding(0) var<storage, read_write> b_W: array<f32>;
@group(0) @binding(1) var<storage, read_write> b_M: array<f32>;
@group(0) @binding(2) var<storage, read_write> b_V: array<f32>;
...
fn main(
  ...
  if ((v_i < 291i)) {
    b_W[v_i] = ((f_hash1((v_i + cw_params.p_seed), cw_thread, cw_block, cw_grid) - 0.5f) * 0.08f);
    b_M[v_i] = 0.0f;
    b_V[v_i] = 0.0f;
    if ((v_i >= 216i)) {
      b_W[v_i] = 0.0f;
