// CUDA WebShader 0.1.0. Generated from kernel schedulePages.
@group(0) @binding(0) var<storage, read> b_Req: array<f32>;
@group(0) @binding(1) var<storage, read_write> b_Queue: array<i32>;
@group(0) @binding(2) var<storage, read_write> b_Stats: array<f32>;
...
fn main(
  ...
  var v_n: i32 = 0i;
  var v_pending: i32 = 0i;
  {
    var v_s: i32 = 0i;
    loop {
      if (!(v_s < 256i)) { break; }
      if ((b_Req[((v_s * 8i) + 3i)] > 0.0f)) {
        v_pending += i32(1);
      }
      continuing {
        v_s += i32(1);
  ...
  }
  {
    ...
    loop {
      ...
      var v_chosen: i32 = (-1i);
      {
        ...
        loop {
          if (!(v_s < 256i)) { break; }
          var v_used: bool = false;
          {
            var v_j: i32 = 0i;
            loop {
              if (!(v_j < 6i)) { break; }
              if (((v_j < v_n) && (b_Queue[(v_j + 1i)] == v_s))) {
                v_used = true;
              }
              continuing {
                v_j += i32(1);
          ...
          var v_score: f32 = b_Req[((v_s * 8i) + 3i)];
          if (((!v_used) && (v_score > v_best))) {
            v_best = v_score;
            v_chosen = v_s;
          }
          continuing {
